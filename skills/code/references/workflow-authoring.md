...
- Group modules by the outcome they maintain. Put feature-independent code in `workflows/shared/`, shared execution in `workflows/flow/`, and workflow-specific code in its named directory.
