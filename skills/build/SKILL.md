...
- Read the selected Issue once at Build start. Its terminal JSON Plan is the sole implementation authority; a publisher-local receipt, second rendering, or body hash is not required.
