...
- [実装開始の条件](implementation-start.md): 現行の開始条件と責任分担、過去の観測・未検証事項を区別した説明です。コードと合意へ照合して手で更新します。
...
新しいページは[wikiテンプレート](../../skills/templates/wiki-template.md)を使います。現行説明と過去の根拠を区別し、要求や権限を文書だけで追加しません。
