...
共通環境の登録切替と新しいタスクでの移行受入は、2026-09-14に[Issue #54](https://github.com/thkt/dotagents/issues/54)で完了しました。採用版・受入結果は同Issueを、今後の保全と登録変更は[開発方針](.codex/DEVELOPMENT.md#旧資産の保全と登録変更)を参照してください。日常作業では上記のスキルと制御CLIの手順を使います。
