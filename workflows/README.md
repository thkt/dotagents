...
- Code uses the same internal review gate as Build. Its review context identifies the direct request with repository `local` and issue `0`; it does not fetch or publish an Issue, and supports repositories without commits.
