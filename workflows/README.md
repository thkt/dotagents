...
- Cross-stage state is versioned independently. Think state v2 and execution revision 2 reject incompatible saved runs with recovery guidance; completed Research and Think report formats remain unchanged.
