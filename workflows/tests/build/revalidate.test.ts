/** @file Outcome: Plan revalidation reliably detects missing, changed, and out-of-repository evidence. */
...
function fixture(): string {
  ...
  fs.writeFileSync(path.join(repo, 'RULES.md'), 'Keep the public value stable.\n');
  return repo;
}
...
function plan(overrides: Record<string, unknown> = {}) {
  return {
    ...
    rules: [{ source: 'RULES.md', quote: 'public value stable' }],
    ...overrides,
  };
}
